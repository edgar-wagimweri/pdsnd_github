...
def get_filters():
    ...
    while True:
      city = input("\nWhich city would you like to filter by? Please note that only 3 cities are currently available. New York City, Chicago or Washington?\n").lower()
      if city not in ('new york city', 'chicago', 'washington'):
        print("Invalid City Selected. Try again! Choose New York, Chicago or Washington")
        continue
      else:
        break
    ...
    while True:
      month = input("\nSelect a month to analyze.  January, February, March, April, May, June or type 'all' if you do not have any preference?\n").lower()
      if month not in ('january', 'february', 'march', 'april', 'may', 'june', 'all'):
        print("Invalid Month Selected. Try again. Choose January, February, March, April, May or June")
        continue
      else:
        break
    ...
    while True:
      ...
      if day not in ('sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'all'):
        print("Invalid Day Selected. Try again.")
        continue
      else:
        break
...
#Sources of refernce: python.org, Stackoverflow.com, tutorialspoint.com
